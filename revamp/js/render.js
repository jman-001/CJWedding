...
function renderSummary() {
    ...
    if (currentInvitation.submitted) {
        ...
        description.textContent = "Ya enviaste tus respuestas anteriormente. Si necesitas hacer algún cambio, por favor comunícate directamente con los novios.";

    } else {

        title.textContent = "Review Your Responses";
        description.textContent = "Please review all your answers before submitting your RSVP.";
