...
async function nextPage() {
    ...
    if (currentStep === 1) {
        ...
        // Ya respondió antes: solo mostrar el resumen, sin permitir editar
...
function updateNavigation() {
    ...
    const isReadOnlyReview = currentStep === 9 && currentInvitation && currentInvitation.submitted;

    // Show / Hide Footer
    if (currentStep === 0 || isReadOnlyReview) {
